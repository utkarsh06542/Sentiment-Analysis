...
# Selected only two columns we require. Game title and its corresponding emotion.
...
# To extract the required columns for inputs and outputs
...
# I will have 11 classes in total for prediction, indices from 0 to 10
